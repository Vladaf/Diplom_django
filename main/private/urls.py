...
urlpatterns = [
    ...
    path("delete_playlist/", views.DeletePlaylistView.as_view(), name="delete_playlist_page"),
    path("edit_song/<song_id>", views.edit_song, name="edit_song_page"),
    path("edit_playlist/<playlist_id>", views.edit_playlist, name="edit_playlist_page"),
]